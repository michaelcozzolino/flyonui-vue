...
export type ShapeableElementName = Extract<ElementName, 'badge' | 'btn' | 'input'>;
export type SizableElementName = Extract<ElementName, 'badge' | 'btn' | 'checkbox' | 'icon' | 'input' | 'loading' | 'menu' | 'select'>;
