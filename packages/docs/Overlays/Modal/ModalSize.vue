<template>
    <FoButton color="primary"
              @click.prevent="isOpen = true; size = 'small'"
    >
        Small
    </FoButton>

    <FoButton color="primary"
              @click.prevent="isOpen = true; size = 'medium'"
    >
        Default
    </FoButton>

    <FoButton color="primary"
              @click.prevent="isOpen = true; size = 'large'"
    >
        Large
    </FoButton>

    <FoButton color="primary"
              @click.prevent="isOpen = true; size = 'extraLarge'"
    >
        Extra large
    </FoButton>

    <FoModal v-model="isOpen"
             :size="size"
    >
        <template #header>
            <FoModalTitle>
...
import type { ModalSize }                  from 'flyonui-vue';
import { FoButton, FoModal, FoModalTitle } from 'flyonui-vue';
import { ref }                             from 'vue';

const isOpen = ref<boolean>(false);
const size   = ref<ModalSize>('medium');
</script>
