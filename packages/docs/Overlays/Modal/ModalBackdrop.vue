<template>
    <FoButton @click.prevent="isOpen = true; backdropType = 'static'">
        Static backdrop
    </FoButton>

    <FoButton @click.prevent="isOpen = true; backdropType = 'disabled'">
        Disabled backdrop
    </FoButton>
...
import type { ModalBackdropType }          from 'flyonui-vue';
import { FoButton, FoModal, FoModalTitle } from 'flyonui-vue';
import { ref }                             from 'vue';

const isOpen       = ref<boolean>(false);
const backdropType = ref<ModalBackdropType>('static');
</script>
