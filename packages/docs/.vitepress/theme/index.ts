...
import AlertDocs                                      from '@/Components/Alert/AlertDocs.vue';
import AvatarDocs                                     from '@/Components/Avatar/AvatarDocs.vue';
import BadgeDocs                                      from '@/Components/Badge/BadgeDocs.vue';
import ButtonDocs                                     from '@/Components/Button/ButtonDocs.vue';
import DiffDocs                                       from '@/Components/Diff/DiffDocs.vue';
...
import RadialProgressDocs                             from '@/Components/RadialProgress/RadialProgressDocs.vue';
import SkeletonDocs                                   from '@/Components/Skeleton/SkeletonDocs.vue';
import StatsDocs                                      from '@/Components/Stats/StatsDocs.vue';
import StatusDocs                                     from '@/Components/Status/StatusDocs.vue';
import SwapDocs                                       from '@/Components/Swap/SwapDocs.vue';
import BlockQuoteDocs                                 from '@/Content/BlockQuote/BlockQuoteDocs.vue';
import DividerDocs                                    from '@/Content/Divider/DividerDocs.vue';
...
import InputFileDocs                                  from '@/Forms/InputFile/InputFileDocs.vue';
import InputTextDocs                                  from '@/Forms/InputText/InputTextDocs.vue';
import JoinDocs                                       from '@/Forms/Join/JoinDocs.vue';
import RadioDocs                                      from '@/Forms/Radio/RadioDocs.vue';
import RangeDocs                                      from '@/Forms/Range/RangeDocs.vue';
...
import DataTableDocs                                  from '@/Tables/DataTable/DataTableDocs.vue';
