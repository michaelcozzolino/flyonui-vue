...
import BorderlessTableRaw       from '@/Tables/Table/BorderlessTable.vue?raw';
...
import HoverableTable           from '@/Tables/Table/HoverableTable.vue';
import HoverableTableRaw        from '@/Tables/Table/HoverableTable.vue?raw';
